...
3. clear the deposit input field afret getting the value
...
document.getElementById('btn-deposit').addEventListener('click', function(){
    // console.log('razu is a good student')
    //step-02
    ...
    // step-7:
    const newBalanceToal = previousBalanceTotalAmount + newDepositTotal;
